...
from file_name import AGENT_RUN_FILE
...
class GroupChatManager(ConversableAgent):
    ...
    def append_line_to_file(self, message):
        current_dir = os.path.dirname(os.path.abspath(__file__))
        file_root = os.path.abspath(os.path.join(current_dir, '../..'))
        file_path = os.path.join(file_root, AGENT_RUN_FILE)
    ...
    def run_chat(
        ...
        for i in range(groupchat.max_round):
            ...
            # 打开文件，并写入文件
            self.append_line_to_file(message)
