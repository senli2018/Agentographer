...
class Namespace:
    """
    Namespace is a virtual container for functions, generated automatically by gptSession
    ...
    def functions_list(self):
        ...
        for module_name, module in self.functions.items():
            #print('module_name.module_name:',module_name)
            func={}
            for function_name, function in module.items():
                func = function.copy()
                func["name"] = "{}-{}".format(module_name, function_name)
                func_map[func['name']]=func['function']
                func_map[func['name']]=self.functions[module_name][function_name]['function']
                del func["function"]
                func_list.append(func.copy())

        #print('result',result)
        return func_list,func_map
